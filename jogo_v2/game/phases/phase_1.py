...
class GameManager:
    ...
    def _create_players(self):
        ...
        player1_damaged_sprite = sprites / "playerBrancoDanificado.png"
        player2_damaged_sprite = sprites / "playerBrancoDanificado.png"

        p1_car = Car(
            x=track1.left + 90,
            y=track1.centery - self.CAR_HEIGHT // 2,
            width=self.CAR_WIDTH,
            height=self.CAR_HEIGHT,
            sprite_path=str(player1_sprite),
            damaged_sprite_path=str(player1_damaged_sprite),
        ...
        p2_car = Car(
            x=track2.left + 90,
            y=track2.centery - self.CAR_HEIGHT // 2,
            width=self.CAR_WIDTH,
            height=self.CAR_HEIGHT,
            sprite_path=str(player2_sprite),
            damaged_sprite_path=str(player2_damaged_sprite),
    ...
    def _draw_ui(self) -> None:
        ...
        title = self.font.render(
            "Corrida Horizontal de Sobrevivência - Fase 1",
            True,
            (255, 255, 255),
        )
        ...
        if self.is_game_over:
            ...
            self.screen.blit(
                result_text,
                (
                    panel.centerx - result_text.get_width() // 2,
                    panel.y + 22,
                ),
            )
            ...
            self.screen.blit(
                detail,
                (
                    panel.centerx - detail.get_width() // 2,
                    panel.y + 62,
                ),
            )
            ...
            self.screen.blit(
                restart,
                (
                    panel.centerx - restart.get_width() // 2,
                    panel.y + 92,
                ),
            )
